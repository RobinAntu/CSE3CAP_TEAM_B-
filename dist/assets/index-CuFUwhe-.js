const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Signup-DOpVLy5G.js","assets/Card-CqNhy3JV.js","assets/Input-BjCZdp41.js","assets/Button-CSPNikPN.js","assets/Checkbox-DLk0g2eR.js","assets/Dashboard-BDeU6Qxy.js","assets/Settings-D6pXxAUC.js","assets/TaskDetails-Cdg0ckDa.js","assets/index.esm-BnAA3k37.js","assets/EditTask-CjrXLKvQ.js","assets/Schedule-BHJuTD_x.js","assets/time-K38avKg6.js","assets/Progress-DjntipgM.js","assets/Wizard-BB505p1Z.js"])))=>i.map(i=>d[i]);
...
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthContext.Provider, { value: { user, loading, login, signup, logout }, children: !loading && children });
}
function useAuth() {
...
function Logo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-text-offset", children: "StudyFlex" })
  ] });
}
function Navbar() {
  const activeClassName = "text-primary font-semibold";
  const inactiveClassName = "text-text-muted hover:text-text-offset";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-surface border-b border-border sticky top-0 z-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex items-center justify-between px-6 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/dashboard", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center space-x-6 text-sm font-medium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/dashboard", className: ({ isActive }) => isActive ? activeClassName : inactiveClassName, children: "Home" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/schedule", className: ({ isActive }) => isActive ? activeClassName : inactiveClassName, children: "Schedule" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/progress", className: ({ isActive }) => isActive ? activeClassName : inactiveClassName, children: "Progress" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/settings", className: ({ isActive }) => isActive ? activeClassName : inactiveClassName, children: "Settings" })
    ] })
  ] }) }) });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-gray-200 bg-white px-4 py-2 text-sm text-gray-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Company · Legal · Contact" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-2 text-lg", children: [
...
function Page({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col bg-[#f9fafb]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl space-y-8", children }) }),
...
const seedCourses = [
  {
    ...
    assessments: [
      {
        title: "Market Report",
        deadlineISO: new Date(Date.now() + 7 * 864e5).toISOString(),
        estHours: 4,
        priority: "high"
      }
    ]
    ...
    assessments: [
      {
        ...
        deadlineISO: new Date(Date.now() + 10 * 864e5).toISOString(),
        estHours: 3,
        priority: "medium"
      }
    ]
  },
  {
    ...
    assessments: [
      {
        title: "Problem Set",
        deadlineISO: new Date(Date.now() + 12 * 864e5).toISOString(),
        estHours: 2,
        priority: "low"
      }
    ]
...
const seedTasks = [
  {
    ...
    subjectId: "c1",
    dueISO: new Date(Date.now() + 3 * 864e5).toISOString(),
    priority: "high",
    estimateHrs: 4,
    actualHrs: 0,
    status: "inprogress"
  },
  {
    ...
    title: "Chapter Review",
    subjectId: "c2",
    dueISO: new Date(Date.now() + 5 * 864e5).toISOString(),
    priority: "medium",
    estimateHrs: 3,
    actualHrs: 0,
    status: "backlog"
  },
  {
    ...
    title: "Problem Set",
    subjectId: "c3",
    dueISO: new Date(Date.now() + 8 * 864e5).toISOString(),
    priority: "low",
    estimateHrs: 2,
    actualHrs: 0,
    status: "backlog"
...
function AppProvider({ children }) {
  ...
  const [courses, setCourses] = reactExports.useState(stored.courses);
  const [events, setEvents] = reactExports.useState(stored.events);
  const [tasks, setTasks] = reactExports.useState(stored.tasks || []);
  const [prefs, setPrefs] = reactExports.useState(stored.prefs);
  reactExports.useEffect(() => {
  ...
  const addSubject = (subject) => {
    ...
    const newCourse = {
      id: `c${(/* @__PURE__ */ new Date()).getTime()}`,
  ...
  const addAssessment = (course_code, assessment) => {
    setCourses(
      (prevCourses) => prevCourses.map((course) => {
  ...
  const addTask = (task) => {
    ...
    if (course) {
      const newTask = {
        id: `t${(/* @__PURE__ */ new Date()).getTime()}`,
        title: task.title,
        subjectId: course.id,
  ...
  const addStudySession = (session) => {
    ...
    if (task) {
      ...
      if (course) {
        const newSession = {
          id: `e${(/* @__PURE__ */ new Date()).getTime()}`,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppContext.Provider, { value: { courses, setCourses, events, setEvents, tasks, setTasks, prefs, setPrefs, addSubject, addAssessment, addFixedSlot, addTask, addStudySession }, children });
}
function useAppContext() {
  return reactExports.useContext(AppContext);
}
const Login = reactExports.lazy(() => __vitePreload(() => import("./Login-Cywt1FTJ.js"), true ? [] : void 0));
const Signup = reactExports.lazy(() => __vitePreload(() => import("./Signup-DOpVLy5G.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const VerifyEmail = reactExports.lazy(() => __vitePreload(() => import("./VerifyEmail-Ds2ctvlL.js"), true ? [] : void 0));
const Dashboard = reactExports.lazy(() => __vitePreload(() => import("./Dashboard-BDeU6Qxy.js"), true ? __vite__mapDeps([5,3,1]) : void 0));
const Settings = reactExports.lazy(() => __vitePreload(() => import("./Settings-D6pXxAUC.js"), true ? __vite__mapDeps([6,1,2,3]) : void 0));
const TaskDetails = reactExports.lazy(() => __vitePreload(() => import("./TaskDetails-Cdg0ckDa.js"), true ? __vite__mapDeps([7,8,1,3,4]) : void 0));
const EditTask = reactExports.lazy(() => __vitePreload(() => import("./EditTask-CjrXLKvQ.js"), true ? __vite__mapDeps([9,1,3,2]) : void 0));
const Schedule = reactExports.lazy(() => __vitePreload(() => import("./Schedule-BHJuTD_x.js"), true ? __vite__mapDeps([10,2,3,11]) : void 0));
const Progress = reactExports.lazy(() => __vitePreload(() => import("./Progress-DjntipgM.js"), true ? __vite__mapDeps([12,11]) : void 0));
const Wizard = reactExports.lazy(() => __vitePreload(() => import("./Wizard-BB505p1Z.js"), true ? __vite__mapDeps([13,8]) : void 0));
function DefaultRoute() {
  const { user } = useAuth();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: user ? "/wizard" : "/login", replace: true });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Loading..." }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        path: "/dashboard",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/settings",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/schedule",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Schedule, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/progress",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Progress, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/wizard",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wizard, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/task/:id",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TaskDetails, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Route,
      {
        path: "/task/edit/:id",
        element: /* @__PURE__ */ jsxRuntimeExports.jsx(RequireAuth, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Page, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(EditTask, {}) }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(DefaultRoute, {}) })
  ] }) }) }) });
}
...
export {
  ...
  sendEmailVerification as d,
  useLocation as e,
  applyActionCode as f,
  useAppContext as g,
  useParams as h,
  commonjsGlobal as i,
  ...
  getApp as m,
  getModularInstance as n,
  getDefaultEmulatorHostnameAndPort as o,
  isCloudWorkstation as p,
  pingServer as q,
  reactExports as r,
  signInWithEmailAndPassword as s,
  updateEmulatorBanner as t,
  useNavigate as u,
  _registerComponent as v,
  registerVersion as w,
  _isFirebaseServerApp as x
};
//# sourceMappingURL=index-CuFUwhe-.js.map
