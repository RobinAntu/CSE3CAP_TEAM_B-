import { j as jsxRuntimeExports, r as reactExports, i as commonjsGlobal, k as getDefaultExportFromCjs, R as React, l as reactDomExports, g as useAppContext } from "./index-CuFUwhe-.js";
import { r as requiredArgs, c as toDate, d as toInteger, g as getDefaultOptions, b as weekDays, a as addDays$1, t as toMinutes, f as format$1 } from "./time-K38avKg6.js";
...
function FiltersBar({ range: range3, onRangeChange, onExport }) {
  function setThisWeek() {
    const start = startOfWeek(/* @__PURE__ */ new Date(), { weekStartsOn: 1 });
    const end = endOfWeek(/* @__PURE__ */ new Date(), { weekStartsOn: 1 });
    onRangeChange({ start, end });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-x-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-blue-600 px-3 py-1 text-white", onClick: setThisWeek, children: "This week" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-x-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-gray-200 px-3 py-1", onClick: onExport, children: "Export report" }) })
  ] });
}
function BoltIcon({
  title,
...
const ForwardRef$3 = /* @__PURE__ */ reactExports.forwardRef(BoltIcon);
...
const ForwardRef$2 = /* @__PURE__ */ reactExports.forwardRef(ChartBarIcon);
...
const ForwardRef = /* @__PURE__ */ reactExports.forwardRef(FireIcon);
function StatsCards({ stats }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4", children: cards.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-4 shadow-sm",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-500", children: c2.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-semibold", children: c2.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-gray-500", children: c2.subtitle })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(c2.icon, { className: "h-8 w-8 text-blue-600" })
      ]
    },
    c2.title
  )) });
...
var Sector = function Sector2(sectorProps) {
  var props = _objectSpread$p(_objectSpread$p({}, defaultProps$2), sectorProps);
...
function requireFindIndex() {
  ...
  var baseFindIndex = require_baseFindIndex(), baseIteratee = require_baseIteratee(), toInteger2 = requireToInteger();
  var nativeMax = Math.max;
...
function StudyTimeChart({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-64 w-full rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "Study time chart", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Study Time by Day" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "day" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "minutes", fill: "#1d4ed8" })
    ] }) })
  ] });
}
function minutesByDay(events, range3) {
  const days = weekDays.map((d) => ({ day: d, minutes: 0 }));
  for (const ev of events) {
    if (ev.kind !== "study") continue;
    const idx = weekDays.indexOf(ev.day);
    if (idx === -1) continue;
    const date2 = addDays$1(range3.start, idx);
    if (!isWithinInterval(date2, range3)) continue;
    const mins = toMinutes(ev.end) - toMinutes(ev.start);
    days[idx].minutes += mins;
  }
  return days;
}
function consecutiveStreak(daily, threshold2 = 30) {
  let streak = 0;
  for (let i = daily.length - 1; i >= 0; i--) {
    if (daily[i].minutes >= threshold2) streak++;
    else break;
  }
  return streak;
}
function focusScore(events, prefs, range3) {
...
function perSubjectTotals(events, tasks, range3) {
  const totals = {};
  for (const ev of events) {
    if (ev.kind !== "study") continue;
    const idx = weekDays.indexOf(ev.day);
...
function buildStats(events, tasks, courses, range3, prefs) {
  const daily = minutesByDay(events, range3);
  const totalMinutes = daily.reduce((a2, b) => a2 + b.minutes, 0);
  const target = courses.reduce((sum, c2) => sum + (c2.weeklyTargetHours || 0) * 60, 0);
  const completed = tasks.filter((t) => t.status === "done").length;
  const focus = focusScore(events, prefs);
...
function buildHeatmap(events, endDate = /* @__PURE__ */ new Date(), weeks = 8) {
  const start = startOfWeek(subWeeks(endDate, weeks - 1));
  const range3 = { start, end: endOfWeek(endDate) };
  const data = [];
  const daily = minutesByDay(events, range3);
  const allDays = eachDayOfInterval(range3);
  for (const d of allDays) {
    const wd = weekDays[d.getDay() === 0 ? 6 : d.getDay() - 1];
    const idx = weekDays.indexOf(wd);
    const minutes = daily[idx] ? daily[idx].minutes : 0;
    data.push({ date: format$1(d, "yyyy-MM-dd"), minutes });
  }
  return data;
}
function ProductivityHeatmap({ events }) {
  ...
  const max2 = Math.max(...data.map((d) => d.minutes), 1);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "Productivity heatmap", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Productivity Heatmap" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 gap-1", children: cells.flat().map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        title: `${format$1(parseISO(c2.date), "eee d MMM")} — ${Math.round(c2.minutes)}m`,
        className: "h-4 w-4 rounded-sm",
        style: { backgroundColor: `rgba(29,78,216,${c2.minutes / max2})` }
      },
      c2.date
    )) })
  ] });
}
function buildBurndown(tasks, range3) {
  const days = eachDayOfInterval(range3);
  ...
  for (let i = 0; i < days.length; i++) {
    daily.push({
      date: format$1(days[i], "yyyy-MM-dd"),
...
function BurndownChart({ tasks }) {
  const range3 = { start: /* @__PURE__ */ new Date(), end: new Date(Date.now() + 14 * 864e5) };
  const data = buildBurndown(tasks, range3);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-64 w-full rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "Burndown chart", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Burndown (next 2 weeks)" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "date", hide: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "remainingHours", stroke: "#ef4444" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "idealHours", stroke: "#1d4ed8", strokeDasharray: "3 3" })
    ] }) })
  ] });
}
function CourseMasteryBars({ events, tasks, courses, range: range3 }) {
  const totals = perSubjectTotals(events, tasks, range3);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "Course mastery", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Course Mastery" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: courses.map((c2) => {
      const mins = totals.studyMinutes[c2.id] || 0;
      const pct = c2.weeklyTargetHours ? Math.min(mins / (c2.weeklyTargetHours * 60), 1) * 100 : 0;
      const tasksDone = totals.doneTasks[c2.id] || 0;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c2.code }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            tasksDone,
            " tasks"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-full rounded bg-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded", style: { width: `${pct}%`, backgroundColor: c2.color || "#1d4ed8" } }) })
      ] }, c2.id);
    }) })
  ] });
}
function FocusGauge({ score }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-64 w-full rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "Focus gauge", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Focus Gauge" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      RadialBarChart,
      {
        ...
        data,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(PolarAngleAxis, { type: "number", domain: [0, 100], angleAxisId: 0, tick: false }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RadialBar, { dataKey: "value", fill: "#1d4ed8", background: true, clockWise: true, cornerRadius: 5 })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-center text-2xl font-semibold", children: score })
  ] });
}
function AIRecommendations({ stats, events, tasks, courses, range: range3 }) {
  const tips = [];
  if (stats.focus < 60) {
    tips.push("Try longer, uninterrupted study sessions to boost focus.");
  }
  const totals = perSubjectTotals(events, tasks, range3);
  for (const c2 of courses) {
    const mins = totals.studyMinutes[c2.id] || 0;
    const target = (c2.weeklyTargetHours || 0) * 60;
    if (target > 0 && mins < target * 0.5) {
      tips.push(`Add 1 session for ${c2.code} to stay on track.`);
    }
  }
  if (!tips.length) tips.push("Great job! You're on track.");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", "aria-label": "AI recommendations", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "AI Recommendations" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "list-disc pl-5 text-sm", children: tips.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: t }, i)) })
  ] });
}
function WeeklyTab({ events, tasks, courses, range: range3, stats }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StudyTimeChart, { data: stats.daily }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProductivityHeatmap, { events }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BurndownChart, { tasks }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CourseMasteryBars, { events, tasks, courses, range: range3 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FocusGauge, { score: stats.focus }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AIRecommendations, { stats, events, tasks, courses, range: range3 })
  ] });
}
function CoursesTab({ events, tasks, courses, range: range3 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CourseMasteryBars, { events, tasks, courses, range: range3 }) });
}
function GoalsTab() {
  const [notes, setNotes] = reactExports.useState("");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gray-200 bg-white p-4 shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-lg font-semibold", children: "Reflection Notes" }),
...
function ReportModal({ open, onClose, stats }) {
  if (!open) return null;
  const node = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg rounded-2xl bg-white p-4 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-4 text-lg font-semibold", children: "Weekly Report" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "report-content", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex justify-end space-x-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-gray-200 px-3 py-1", onClick: () => printReport(document.getElementById("report-content")), children: "Print" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-blue-600 px-3 py-1 text-white", onClick: () => downloadCSV("study_time_by_day.csv", [["day", "minutes"], ...stats.daily.map((d) => [d.day, d.minutes])]), children: "CSV" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-gray-200 px-3 py-1", onClick: onClose, children: "Close" })
    ] })
  ] }) });
  return reactDomExports.createPortal(node, document.body);
}
function Progress() {
  const { events, tasks, courses, prefs } = useAppContext();
  const [range3, setRange] = reactExports.useState({ start: startOfWeek(/* @__PURE__ */ new Date(), { weekStartsOn: 1 }), end: endOfWeek(/* @__PURE__ */ new Date(), { weekStartsOn: 1 }) });
  const [tab, setTab] = reactExports.useState("weekly");
  const [reportOpen, setReportOpen] = reactExports.useState(false);
  const stats = buildStats(events, tasks, courses, range3, prefs);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-semibold", children: "Progress" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: "Track learning over time" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "rounded bg-blue-600 px-3 py-1 text-white", onClick: () => setReportOpen(true), children: "Export" }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FiltersBar, { range: range3, onRangeChange: setRange, onExport: () => setReportOpen(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatsCards, { stats }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex space-x-4 border-b", children: [["weekly", "Weekly"], ["courses", "Courses"], ["goals", "Goals"]].map(([key, label]) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: `pb-2 ${tab === key ? "border-b-2 border-blue-600" : ""}`, onClick: () => setTab(key), children: label }, key)) }),
    tab === "weekly" && /* @__PURE__ */ jsxRuntimeExports.jsx(WeeklyTab, { events, tasks, courses, range: range3, stats }),
    tab === "courses" && /* @__PURE__ */ jsxRuntimeExports.jsx(CoursesTab, { events, tasks, courses, range: range3 }),
    tab === "goals" && /* @__PURE__ */ jsxRuntimeExports.jsx(GoalsTab, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ReportModal, { open: reportOpen, onClose: () => setReportOpen(false), stats })
  ] });
}
export {
  Progress as default
};
//# sourceMappingURL=Progress-DjntipgM.js.map
